...
public class GPUImageFilterTools {
	...
	public final FilterList filters = new FilterList();
    ...
    public GPUImageFilterTools()
    {
         ...
         filters.addFilter("White", FilterType.WHITE_BALANCE); // White Balance
         ...
         filters.addFilter("Blend", FilterType.BLEND_COLOR_BURN);  // Blend (Color Burn)
         ...
         filters.addFilter("Amatorka", FilterType.LOOKUP_AMATORKA);  // Lookup (Amatorka)
    }
